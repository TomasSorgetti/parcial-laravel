<div class="relative">
    ...
    <ul id="authDropdownMenu" class="absolute top-10 right-0 min-w-40 bg-white text-black rounded p-4 shadow hidden flex-col gap-3 shadow-lg">
        <li><a href="{{ route('admin') }}" class="w-full py-1 block">Dashboard</a></li>
